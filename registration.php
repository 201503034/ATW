    ...
    <div class="row login-container column-seperation">
      ...
      <div class="col-md-5 "> <br>
        ...
        <form id="validate" class="login-form" action="" method="post">
            ...
            <div class="form-group col-md-10">
              ...
              <div class="controls">
                ...
                <span class="help-block">
                  <div style="color:#F00;" id="errname"></div>
                </span>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="form-group col-md-10">
              ...
              <div class="controls">
                ...
                <span class="help-block">
                  <div style="color:#F00;" id="vldt"></div>
                </span>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="form-group col-md-10">
              ...
              <div class="controls">
                ...
                <span class="help-block">
                  <div style="color:#F00;" id="pwd"></div>
                </span>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="form-group col-md-10">
              ...
              <div class="controls">
                ...
                <span class="help-block">
                  <div style="color:#F00;" id="cpwd"></div>
                  <div style="color:#F00;" id="mpwd"></div>
                </span>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="form-group col-md-10">
              <label class="form-label">Activate Google Authentication</label>
              <span class="help"></span>
              <div class="controls">
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="checkbox" data-toggle="toggle" checked disabled name="auth">
                </div>
